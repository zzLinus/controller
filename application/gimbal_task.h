...
//视觉坐标死区
#define CV_DEADBAND   3

//视觉画面大小
#define CV_SIZE_X 640
#define CV_SIZE_Y 480

//比例因子
#define YAW_CV_SEN    -0.000006f  //未使用
#define PITCH_CV_SEN  -0.000007f  //未使用

#define YAW_RC_SEN    -0.000010f //-0.000005f
#define PITCH_RC_SEN  -0.000011f //-0.000006f

#define YAW_MOUSE_SEN   0.00008f //0.00005f
#define PITCH_MOUSE_SEN 0.00014f //0.00015f
...
#define YAW_OFFSET_ECD_FORWARD			2254
#define YAW_OFFSET_ECD_BACKWARD			6289
#else
	#ifdef INFANTRY2_ZHANG
	#define YAW_OFFSET_ECD_FORWARD			4200
	#define YAW_OFFSET_ECD_BACKWARD			77
	#endif
#endif
...
typedef enum
{
    ...
    GIMBAL_MOTOR_ENCONDE, //电机编码值角度控制
		GIMBAL_MOTOR_CV,			//电机CV控制模式 (不使用增量，直接使用位置量)
} gimbal_motor_mode_e;
...
typedef enum
{
	GIMBAL_YAW_FORWARD,
	GIMBAL_YAW_BACKWARD,
} gimbal_yaw_direction_e;  // yaw云台向前或向后
