...
电机数据, 0:底盘电机1 3508电机,  1:底盘电机2 3508电机,2:底盘电机3 3508电机,3:底盘电机4 3508电机;
		4:yaw云台电机 6020电机; 5:pitch云台电机 6020电机; 6:拨弹电机 2006电机; 7:摩擦轮1; 8:摩擦轮2*/
static motor_measure_t motor_chassis[9];  // 最后两位是摩擦轮电机
static can_CV_t can_CV;  // CV结构体
...
//					can_CV.y = ((int)rx_data[3])*100 + ((int)rx_data[4])*10 + ((int)rx_data[5]);
					...
					can_CV.cv_recv_time = xTaskGetTickCount();  // 获取节拍值
...
void CAN_cmd_fric(int16_t motor1, int16_t motor2)
{
    ...
    fric_can_send_data[3] = motor1;
		...
		fric_can_send_data[4] = 0;  // reserve 保留
